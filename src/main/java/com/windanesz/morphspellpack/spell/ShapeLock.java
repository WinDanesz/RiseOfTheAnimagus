...
public class ShapeLock extends SpellRay {

	public ShapeLock() {
		super(MorphSpellPack.MODID, "shape_lock", SpellActions.POINT, false);
	...
	protected boolean onEntityHit(World world, Entity target, Vec3d hit,
		...
		if (target instanceof EntityLivingBase) {
			((EntityLivingBase) target).addPotionEffect(
					new PotionEffect(MSPotions.shape_lock, (int) (getProperty(EFFECT_DURATION).floatValue() * modifiers.get(WizardryItems.duration_upgrade))));
			return true;
		}
		return false;
	}
